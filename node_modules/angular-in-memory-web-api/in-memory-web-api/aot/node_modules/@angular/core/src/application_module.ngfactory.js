...
var ApplicationModuleInjector = (function (_super) {
    ...
    Object.defineProperty(ApplicationModuleInjector.prototype, "_TRANSLATIONS_FORMAT_10", {
        get: function () {
            if ((this.__TRANSLATIONS_FORMAT_10 == null)) {
                (this.__TRANSLATIONS_FORMAT_10 = null);
            }
    ...
    ApplicationModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import17.TRANSLATIONS_FORMAT)) {
